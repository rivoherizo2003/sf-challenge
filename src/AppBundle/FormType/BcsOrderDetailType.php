 ...
 * Time: 09:23
 */
class BcsOrderDetailType extends AbstractType
{
	/**
	...
	public function buildForm(FormBuilderInterface $builder, array $options)
	{
		...
		$builder
            ...
            ->add('oddPrice',MoneyType::class, array(
                'currency' => 'MGA',
                'required' => true,
                'attr' => ['class' => 'txt-price']
            ))
            ->add('oddQuantity', TextType::class, [
                'attr' => [ 'class' => 'text-right txt-quantity-ordered', 'min' => '1'],
                'translation_domain'=>'translations'
            ])
            ->add('oddStockQuantity', TextType::class, [
                'attr' => ['readonly' => true, 'class' => 'txt-stock-quantity text-right'],
                'translation_domain'=>'translations'
            ])
            ->add('oddUnitOfMeasure', EntityType::class, [
	...
	public function configureOptions(OptionsResolver $resolver)
	{
		...
		$resolver->setDefaults(
			array(
				'data_class' => BcsOrderDetail::class,
